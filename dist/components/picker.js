...
var Picker = function (_React$PureComponent) {
  ...
  function Picker(props) {
    ...
    var includeRecent = props.include && props.include.length ? props.include.indexOf(RECENT_CATEGORY.id) > -1 : true;
    var excludeRecent = props.exclude && props.exclude.length ? props.exclude.indexOf(RECENT_CATEGORY.id) > -1 : false;
  ...
  (0, _createClass3.default)(Picker, [{
    ...
    value: function render() {
      ...
      var calculatedWidth = perLine * (emojiSize + 12) + 12 + 2 + (0, _utils.measureScrollbar)();

      var finalWidth = width || calculatedWidth;

      return _react2.default.createElement(
        'div',
        { style: (0, _extends3.default)({ width: finalWidth }, style), className: 'emoji-mart' },
